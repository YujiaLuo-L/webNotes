...
function watermark() {
  ...
  for (let i = 0; i < defaultSettings.watermark_rows; i++) {
    ...
    for (let j = 0; j < defaultSettings.watermark_cols; j++) {
      ...
      maskDiv.style.zIndex = defaultSettings.watermark_index.toString();
...
````
<img src='../img/JS/添加水印.png' alt='甘肃北斗项目添加水印'/>

**遇到的问题**
添加的水印，点击时会影响地图的操作（水印字的地方会挡住操作）
解决办法
maskDiv.style.userSelect = 'none';
maskDiv.style.pointerEvents = 'none';
